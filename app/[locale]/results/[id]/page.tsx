    ...
    <div className="min-h-screen flex flex-col bg-[#f5f5f5]">
      ...
      <nav className="bg-white border-b border-gray-200 py-3 px-4 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto flex flex-wrap justify-center gap-4 text-sm">
          <a href="#compatibility" className="text-[#8B3A3A] hover:underline">{t('compatibilityLink')}</a>
          <a href="#desires" className="text-[#8B3A3A] hover:underline">{t('desiresLink')}</a>
        </div>
      </nav>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                <p className="text-4xl font-bold text-[#8B3A3A]">{matches.totalMatches}</p>
            ...
            <div className="mt-6 space-y-4">
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    className="bg-gradient-to-r from-[#8B3A3A] to-[#6B2D2D] h-3 rounded-full"
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            {!isPaid && lockedCount > 0 && (
              <div className="mt-8 p-6 bg-gradient-to-r from-[#8B3A3A] to-[#6B2D2D] rounded-xl text-white">
                {/* Limited time badge */}
                ...
                <button
                  ...
                  className="w-full bg-white text-[#8B3A3A] py-4 px-6 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors shadow-lg"
                >
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="text-[#8B3A3A] text-sm hover:underline"
              >
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <Link
                href="/feedback"
                className="px-4 py-2 bg-[#8B3A3A] text-white rounded-lg text-sm hover:bg-[#6B2D2D] transition-colors"
              >
                💬 {t('leaveFeedback')}
              </Link>
            </div>
      ...
      {!isPaid && lockedCount > 0 && (
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-[#8B3A3A] to-[#6B2D2D] p-4 shadow-lg md:hidden z-50">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              onClick={handlePayment}
              className="bg-white text-[#8B3A3A] px-6 py-3 rounded-lg font-bold text-sm hover:bg-gray-100 transition-colors whitespace-nowrap"
            >
              🔓 Unlock Now
            </button>
          </div>
