          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={handleCopy}
                  className="px-4 py-2 bg-[#a83232] text-white rounded-lg text-sm font-medium hover:bg-[#8b2828] transition-colors"
                >
            ...
            <Link
              href={`/results/${quizId}`}
              className="inline-block mt-6 text-[#a83232] hover:underline text-sm"
            >
              {t('viewResults')} →
            </Link>
          </div>
